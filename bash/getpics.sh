...
# downloading a tar file (if it is not downloaded)
...
# retrieveing and erasing the old files kept in tarfile
test -f ~/Pictures/pics.tgz && tar -xzf ~/Pictures/pics.tgz -C ~/Pictures/pics && rm ~/Pictures/pics.tgz
